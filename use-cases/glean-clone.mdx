---
title: "Building Your Own Glean with Cortex (In Progress 🚧)"
...
```
┌─────────────────┐    ┌─────────────────┐    ┌─────────────────┐
│   Frontend UI   │    │   Backend API   │    │   Cortex APIs   │
│                 │    │                 │    │                 │
│ • Search UI     │◄──►│ • Data Sync     │◄──►│ • QnA Engine    │
│ • Chat Interface│    │ • Auth/ACL      │    │ • Document Index│
│ • Results View  │    │ • App Connectors│    │ • Memory Store  │
└─────────────────┘    └─────────────────┘    └─────────────────┘
         │                       │                       │
         │                       │                       │
         ▼                       ▼                       ▼
┌─────────────────┐    ┌─────────────────┐    ┌─────────────────┐
│   Data Sources  │    │  App Connectors │    │ Retrieval Layer │
│                 │    │                 │    │                 │
│ • Google apps   │    | • Compositio    │    │ • Cortex Memory │
│ • Slack         │    │ • Vanilla APIs  │    │ • User Sessions │
│ • Notion        │    │ • Webhooks      │    │ • Metadata Store│
│ • Jira          │    │ • Scheduled Jobs│    │                 │
└─────────────────┘    └─────────────────┘    └─────────────────┘
```
...
#### Option A: Using Compositio
[Compositio](https://compositio.com) provides pre-built connectors for popular apps:

```javascript
// Example: Setting up Compositio connector
const compositioConfig = {
  connectors: [
    {
      name: 'slack',
      config: {
