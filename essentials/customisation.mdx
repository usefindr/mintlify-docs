...
Let your users define how they want the AI to respond. They can set preferences like: format (tables, bullets), tone (friendly, concise), depth (summary vs deep dive), or structure (comparison vs explanation).
