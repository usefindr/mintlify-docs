...
- `tenant_metadata` (object, optional): Custom metadata object to associate with the uploaded content for tenant-level filtering (e.g., department, compliance_tag)
- `document_metadata` (object, optional): Custom metadata object to associate with the uploaded content for document-level filtering (e.g., title, author)
