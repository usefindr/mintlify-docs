...
**Example Error Response for Duplicate File ID:**
```json
{
  "error": "File ID already exists",
  "message": "Text content with file_id 'text_123456' already exists. The existing content will be overwritten with the new content.",
  "file_id": "text_123456",
