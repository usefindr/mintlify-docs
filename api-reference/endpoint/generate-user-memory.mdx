...
curl -X POST "https://api.cortex.com/user_memory/generate_user_memory" \
  ...
  -d '{
    ...
    "user_message": "I just finished working on the authentication system. I prefer using JWT tokens over session-based auth because they're stateless and work better with our microservices architecture. I also learned that implementing rate limiting is crucial for security.",
