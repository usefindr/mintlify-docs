...
Automatically generates and saves echo memories based on a user query. This is the most sophisticated endpoint that combines query processing, memory generation, and storage.
