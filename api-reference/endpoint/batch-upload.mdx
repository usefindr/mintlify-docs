...
**Example Error Response for Duplicate File IDs in Batch:**
```json
{
  "error": "Duplicate file IDs detected",
  "message": "Some file_ids in the batch already exist and will be overwritten",
  "duplicate_file_ids": ["doc_123456", "doc_789012"],
  "status": "overwrite_warning",
  "successful_uploads": ["doc_345678", "doc_901234"]
}
```
