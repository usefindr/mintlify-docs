...
**Example Error Response for Duplicate File IDs in App Upload:**
```json
{
  "error": "Duplicate file IDs detected",
  "message": "Some file_ids in the app upload already exist and will be overwritten",
  "duplicate_file_ids": ["gmail_123456", "slack_789012"],
  "status": "overwrite_warning",
  "successful_uploads": ["notion_345678", "drive_901234"]
}
```
