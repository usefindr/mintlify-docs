---
title: "Meet Cortex: The retrieval layer with built-in memory"
description: "See how Cortex personalises your LLM apps, delivers exceptional results, and delights your users with a great experience."
---
...
1. **Obtain Your API Key:** You’ll need a API Key to interact with the API. Please [**contact us**](mailto:founders@usecortex.com?subject=Interested%20in%20Cortex&body=Hey%20Cortex%20team%2C%0A%0AI%20had%20a%20question%20about%20the%20SDK.%20Would%20love%20to%20chat.) to request an API key.
...
Feel free to [**reach out**](mailto:founders@zeroentropy.dev) if you have any questions or need assistance getting started.